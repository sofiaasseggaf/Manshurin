...
public class ModelRiwayatPembelian {

    int id_riwayat;
    String harga, harga_katul, jenis_pembayaran, tgl_input, tgl_update;

    public ModelRiwayatPembelian(int id_riwayat, String harga, String harga_katul, String jenis_pembayaran, String tgl_input, String tgl_update) {
