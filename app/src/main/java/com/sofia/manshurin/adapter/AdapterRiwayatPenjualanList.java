...
public class AdapterRiwayatPenjualanList extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    List<ModelPenjualan> dataItemList;
    List<ModelBarang> dataBarang;
    DecimalFormat formatter;

    public AdapterRiwayatPenjualanList(List<ModelPenjualan> dataItemList,  List<ModelBarang> dataBarang) {
